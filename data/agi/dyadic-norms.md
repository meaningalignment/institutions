...
1. Resulting norms must be legible to human overseers
2. No norm can emerge that either agent's principal would reject if they understood it
3. The protocol must prevent the stronger agent from simply imposing its preferred norms
4. Norms must be revisable as conditions change
