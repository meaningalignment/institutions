...
1. Under what conditions can an AI-discovered agreement be treated as a legitimate proposal (not just an interesting suggestion)?
2. What institutional safeguards prevent "supernegotiation" from becoming a vector for laundering politically unacceptable tradeoffs through technical complexity?
3. How do you preserve the quality gains from superhuman search of agreement space without bypassing democratic authorization?
