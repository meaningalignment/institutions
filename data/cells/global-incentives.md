...
1. **Labor share rebuilt as ownership share.** Humans receive income because they own a structurally-protected stake in productive capacity, not because they work. Possible shapes: universal capital endowments at birth; citizens' dividends from progressive taxation of AI-generated revenue; sovereign-wealth-style claims on AI productivity (Norway's GPFG scaled up and generalized); pension-fund-style claims on AI-augmented industries; hybrid premium-and-dividend structures where humans subscribe to ownership pools that capture rents on AI activity. The shapes differ on whether the stake is national or transnational, whether it is funded by taxation or by direct equity, whether the dividend is uniform or weighted, and whether the claim is entrenched constitutionally or treaty-bound.

2. **Consumer preference rebuilt via outcome-procurement intermediaries.** What the economy produces gets pulled toward measured human flourishing rather than platform-amplified engagement. Possible shapes: a layer of market intermediaries that assess what humans actually need, bundle similar needs across subscribers, and procure outcomes via outcome-verified contracts (combinatorial risk-sharing auctions paired with actuarial pools are one fully-worked version of this); mandatory human-mediation requirements in defined consumer-choice transactions; assistant-agent fiduciary structures that bind buyer-side agents to substantive principal preferences across jurisdictions; structured preference-elicitation systems that surface what humans say they want when asked carefully, separate from what they click. The shapes differ on whether the substitute aggregation is centralized or distributed, mandatory or opt-in, outcome-verified or preference-elicited.

3. **Explicit steering rebuilt with non-economic weight.** Mechanisms for human collective input into market direction that don't depend on consumer-spending or labor leverage. Possible shapes: deliberative citizen assemblies with binding remit over sectoral AI deployment; weighted-representation mechanisms in industry standards bodies; vetoes routed through subscriber-owned pools; statutory rights of refusal in defined transaction classes; public-investment screens with democratic input. The shapes differ on whether the voice is per-issue or representative, advisory or binding, jurisdictionally bound or transnational.

4. **Hard limits on AI market participation.** Global treaty restrictions on AI ownership of assets, on AI as principal to certain contracts, on AI-only market segments, with mandatory human intermediation in defined transaction classes. Possible shapes: a WTO-analogue for AI economic participation with binding dispute resolution; sector-specific treaty bans (no AI principalship in elections, healthcare, education); mandatory human intermediation backed by reciprocity-based enforcement; coordinated AI-revenue taxation feeding a global dividend pool; capture-resistant funding for the treaty body itself. The shapes differ on what is restricted, how broadly the treaty covers, and how enforcement crosses borders against defection.
