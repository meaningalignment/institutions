...
5. **Diffusion.** The working example reshapes what counts as a legitimate institution elsewhere. It does not have to be copied; it has to exist, as a place to point.

## A worked example

The American Revolution went through something like these steps. The theory came first, from Locke and other social-contract thinkers. Institution designers like the founding fathers turned it into working machinery: the constitutions and the Declaration. It was adopted first in one place (America). After that it spread. The French and Latin American revolutions weren't copies of the American one, but they could point to it as proof that a modern liberal state could work.
